...

{
    ...
    float3 envLightSource_SkyboxIntensity = max(
        SampleBakedGI(objPos, float3(0.0, 0.0, 0.0), input.texCoord1.xy, input.texCoord2.xy, true),
        SampleBakedGI(objPos, float3(0.0, -1.0, 0.0), input.texCoord1.xy, input.texCoord2.xy, true)
        ).rgb;
